    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'icon'        => 'far fa-newspaper nav-icon'
        ],
        [
        ...
        [
            'text'        => 'Фон для товаров',
            'route'       => 'import.background.show',
            'icon'        => 'fas fa-file-import nav-icon'
        ],
    ],
        ...
        'Select2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/sweetalert2/css/select2.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/sweetalert2/css/sweetalert2.min.css',
                ],
            ],
        ],
        'Bootstrap Switch' => [
