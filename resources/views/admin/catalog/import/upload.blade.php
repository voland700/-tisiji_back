...
@section('title', 'Импорт данных, загрузка товаров каталога из EXCEL - файла' )
...
@section('content')
    ...
    <div class="col-md-9">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        Скачать <a href="/excel/import_products.xlsx" download> шаблон для импорта</a>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('import.uploud')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
